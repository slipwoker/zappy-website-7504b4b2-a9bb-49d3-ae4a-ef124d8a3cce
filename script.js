        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '7504b4b2-a9bb-49d3-ae4a-ef124d8a3cce',
            ...
            if (response.ok) {
              ...
              console.log('⚠️ Zappy: API returned error status', response.status, result);
            }
          } catch (error) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Go Rapido משלוחים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
